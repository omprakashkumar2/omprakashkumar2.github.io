...
- Developed python scripts to create bulk table on iceberg in all layers- Bronze, Silver and Gold Layers.
- Migrated data from snowflake, vertica, API, csv file and loaded into Data Lake using sql and PySpark Scripts.
- Experience in extracting appropriate data from datasets in order to handle bad, null, duplicate records using SparkSQL.
...
**Data Engineer @Orient Technologies, Mumbai, India (_July 2021 - Oct 2023_)**
...
- Directly involved in creating Azure Linked Services, Datasets, triggers etc. as part of data ingestion.
- Built and monitor 20+ ETL data pipelines to pull data from on-premise server, SQL Database, Azure Synapse, Azure blob storage, Data Lake and SFTP using copy, foreach, lookup, stored produce, web, metadata activities in ADF.
